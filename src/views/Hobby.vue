...
export default {
  ...
  methods: {
    async load() {
      try {
        const res = await axios.get("https://frontend.idaman.co.id/api/hobby/");
    ...
    async add() {
      try {
        await axios.post("https://frontend.idaman.co.id/api/hobby/", this.form);
        await this.load();
        this.form.name = "";
      } catch (err) {
        console.log(err);
    ...
    async del(user) {
      ...
      try {
        const res = await axios.delete(
          "https://frontend.idaman.co.id/api/hobby/" + user.id
        );
        console.log(res);
        await this.load();
      } catch (err) {
